"""
indexing.py — Embed text chunks with Gemini embeddings and store in MongoDB.
From nikhil branch, adapted to use our env vars.
"""
...
MONGODB_DB = os.getenv("MONGO_DB_NAME") or os.getenv("MONGODB_DB", "cognipath")
