...
async def process_video(req: VideoProcessRequest, current_user: User = Depends(get_current_user)):
    """
...
async def get_relevant_snippets(req: SnippetRequest, current_user: User = Depends(get_current_user)):
    """
